...
namespace Homework_4.Migrations
{
    ...
    [Migration("20240321123143_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Seminar_2.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Seminar_2.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Seminar_2.Models.Storage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProductStorage", b =>
                {
                    b.HasOne("Seminar_2.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Seminar_2.Models.Storage", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Seminar_2.Models.Product", b =>
                {
                    b.HasOne("Seminar_2.Models.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
